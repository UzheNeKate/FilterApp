...
public class GaussianFilterTask extends AsyncTask<Void, Void, Bitmap> {
    ...
    public GaussianFilterTask(GaussianFilter filter, ImageView view, FiltersActivity main) {
        super();
        this.filter = filter;
        this.view = view;
        this.main = main;
