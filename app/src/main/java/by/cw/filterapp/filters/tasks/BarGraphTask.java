...
public class BarGraphTask extends AsyncTask<Void, Void, Bitmap> {
    ...
    public BarGraphTask(BarGraph filter, ImageView view, FiltersActivity main) {
        super();
        this.filter = filter;
        this.view = view;
        this.main = main;
    ...
    protected Bitmap doInBackground(Void... voids) {
        return filter.equalizeRgb();
    }

    @Override
    protected void onPostExecute(Bitmap result) {
        main.barGraphRgbBitmap = result;
