...
public class MedianFilterTask extends AsyncTask<Void, Void, Bitmap> {
    ...
    public MedianFilterTask(MedianFilter filter, ImageView view, FiltersActivity main) {
        super();
        this.filter = filter;
        this.view = view;
        this.main = main;
    ...
    protected Bitmap doInBackground(Void... voids) {
        return filter.filterImage(3);
    }

    @Override
    protected void onPostExecute(Bitmap result) {
        main.medianBitmap = result;
